...
<body class="easyui-layout">
    ...
    <div data-options="region:'west',split:true" style="width:200px;">
           <div class="easyui-accordion" style="width:193px;height:530px;">
               ...
               <div title="仓库管理员操作" data-options="iconCls:'icon-add'" style="padding:10px;">
              	   <div style="padding:5px 0;">
      					<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-edit',size:'large',iconAlign:'top'" onclick="addTab('&nbsp;&nbsp;&nbsp;&nbsp;查询&nbsp;&nbsp;&nbsp;&nbsp;','./../storeHouse/showSearch')">&nbsp;&nbsp;&nbsp;&nbsp;查询&nbsp;&nbsp;&nbsp;&nbsp;</a><br /><br />
       					<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-cancel',size:'large',iconAlign:'top'" onclick="addTab('&nbsp;&nbsp;&nbsp;&nbsp;进仓&nbsp;&nbsp;&nbsp;&nbsp;','./../storeHouse/showIn')">&nbsp;&nbsp;&nbsp;&nbsp;进仓&nbsp;&nbsp;&nbsp;&nbsp;</a><br /><br />
               ...
               <div title="货管操作" data-options="iconCls:'icon-add'" style="padding:10px;">
                   <div style="padding:5px 0;">
      					<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-edit',size:'large',iconAlign:'top'" onclick="addTab('&nbsp;&nbsp;&nbsp;&nbsp;货品&nbsp;&nbsp;&nbsp;&nbsp;','./../goodsManager/showManage')">&nbsp;&nbsp;&nbsp;&nbsp;货品&nbsp;&nbsp;&nbsp;&nbsp;</a><br /><br />
       					<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-cancel',size:'large',iconAlign:'top'" onclick="addTab('&nbsp;&nbsp;&nbsp;&nbsp;进货&nbsp;&nbsp;&nbsp;&nbsp;','./../goodsManager/showBuy')">&nbsp;&nbsp;&nbsp;&nbsp;进货&nbsp;&nbsp;&nbsp;&nbsp;	</a>
   				   </div>
               </div>
           </div>
       </div>
    <div data-options="region:'center'," style="padding:5px;background:#eee;">
       ...
       <div data-options="region:'south',split:true" style="height:30px;"><center>Copyright © topsports版权所有</center></div>
</body>
</html>